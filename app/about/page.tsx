...
export default function AboutPage() {
  return (
    <section className="relative mx-auto flex min-h-[calc(100dvh-13rem)] w-full max-w-350 items-center justify-center">
      ...
      <h1 className="font-display text-center text-6xl leading-[0.85] text-ink md:text-8xl mb-4">
        Design. <span className="block md:inline mt-2 md:mt-0">Develop.</span>
      </h1>
      <h2 className="font-display text-outline text-center text-6xl leading-[0.85] md:text-8xl">
        Deliver.
      </h2>
