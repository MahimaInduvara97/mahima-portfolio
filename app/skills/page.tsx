...
export const metadata: Metadata = {
  title: "Skills",
  description: "Frontend tools and technologies Mahima Induvara uses to build modern web apps.",
};
...
const skills = [
  ...
  },
  {
    ...
    desc: "CMS & themes",
    glyph: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0,0,256,256" width="20px" height="20px" fillRule="nonzero"><g fill="#ffffff" fillRule="nonzero" stroke="none" strokeWidth="1" strokeLinecap="butt" strokeLinejoin="miter" strokeMiterlimit="10" strokeDasharray="" strokeDashoffset="0" fontFamily="none" fontWeight="none" fontSize="none" textAnchor="none"><g transform="scale(5.12,5.12)"><path d="M25,2c-12.683,0 -23,10.318 -23,23c0,12.682 10.317,23 23,23c12.683,0 23,-10.318 23,-23c0,-12.682 -10.317,-23 -23,-23zM25,7c4.26,0 8.166,1.485 11.247,3.955c-0.956,0.636 -1.547,1.74 -1.547,2.945c0,1.6 0.9,3 1.9,4.6c0.8,1.3 1.6,3 1.6,5.4c0,1.7 -0.5,3.8 -1.5,6.4l-2,6.6l-7.1,-21.2c1.2,-0.1 2.3,-0.2 2.3,-0.2c1,-0.1 0.9,-1.6 -0.1,-1.6c0,0 0,0 -0.1,0c0,0 -3.2,0.3 -5.3,0.3c-1.9,0 -5.2,-0.3 -5.2,-0.3c0,0 0,0 -0.1,0c-1,0 -1.1,1.6 -0.1,1.6c0,0 1,0.1 2.1,0.2l3.1,8.4l-4.3,12.9l-7.2,-21.4c1.2,-0.1 2.3,-0.2 2.3,-0.2c1,-0.1 0.9,-1.6 -0.1,-1.6c0,0 0,0 -0.1,0c0,0 -2.152,0.202 -4.085,0.274c3.288,-4.294 8.453,-7.074 14.285,-7.074zM7,25c0,-1.8 0.271,-3.535 0.762,-5.174l7.424,20.256c-4.925,-3.211 -8.186,-8.759 -8.186,-15.082zM19.678,42.2l5.322,-15.6l5.685,15.471c-1.788,0.594 -3.696,0.929 -5.685,0.929c-1.853,0 -3.64,-0.281 -5.322,-0.8zM35.304,39.75v0l5.296,-15.35c0.786,-2 1.21,-3.742 1.39,-5.304c0.643,1.851 1.01,3.832 1.01,5.904c0,6.111 -3.046,11.497 -7.696,14.75z"/></g></g></svg>
    ),
  },
  {
    name: "Supabase",
